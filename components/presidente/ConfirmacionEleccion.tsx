...
const styles = StyleSheet.create({
  ...
  titulo: { fontSize: 30, fontWeight: '900', color: C.txtPrimario, textAlign: 'center' },
  sub: { fontSize: SIZES.txtBody, color: C.txtSecundario, textAlign: 'center' },
  listaCands: { gap: 10 },
  candFila: {
    flexDirection: 'row', alignItems: 'center', gap: 12,
    backgroundColor: C.blanco, borderRadius: SIZES.radiusSm,
    padding: 16, borderWidth: 1, borderColor: C.borde,
  },
  candIcono: { fontSize: 24 },
  candNombre: { fontSize: SIZES.txtBody, color: C.txtPrimario, fontWeight: '700', flex: 1 },
  pesoBadge: {
  ...
  aviso: { fontSize: SIZES.txtCaption, color: C.txtSecundario, textAlign: 'center', lineHeight: 22 },
  btnConfirmar: {
